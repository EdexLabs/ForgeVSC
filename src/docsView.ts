...
function showPanel(title: string, html: string): void {
    if (activePanel) {
        ...
        activePanel = vscode.window.createWebviewPanel(
            'forgevsc.docs', title, { viewColumn: vscode.ViewColumn.One, preserveFocus: true },
...
export function registerDocsView(extCtx: vscode.ExtensionContext, channel: vscode.OutputChannel): void {
    ...
    extCtx.subscriptions.push(
        vscode.window.createTreeView('forgevsc.explorerView', {
    ...
    extCtx.subscriptions.push(
        // ── Docs openers ──
        vscode.commands.registerCommand('forgevsc.openFunctionDocs', (input: FnMeta | string) => {
        ...
        vscode.commands.registerCommand('forgevsc.openEnumDocs', (input: EnumMeta | string) => {
        ...
        vscode.commands.registerCommand('forgevsc.openEventDocs', (input: EventMeta | string) => {
        ...
        vscode.commands.registerCommand('forgevsc.openGuide', (input: GuideMetadata | number | string) => {
